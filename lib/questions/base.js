...
exports.list = [
  ...
  },
  {
    ...
    message: 'Describe the company, its products and operations (to be used in report generation)'
  },
  {
    type: 'input',
  ...
  },
  {
    ...
    message: 'List members of the Security Committee (e.g. Security Officer, Privacy Officer, CTO, COO, etc.)'
  },
  {
    type: 'confirm',
  ...
  },
  {
    ...
    message: 'Do you want to customize the look and feel of your policy HTML output files (i.e. MkDocs styling)',
    default: false
  },
  {
    type: 'input',
  ...
  },
  {
    ...
    message: 'Where will publish your Security Policies (e.g. https://yourcompany.com/security)',
    validate: validate.webURL
  },
  {
    type: 'input',
    name: 'privacyPolicyURL',
    message: 'Where will publish your Privacy Policies (e.g. https://yourcompany.com/privacy)',
    validate: validate.webURL
  },
  {
    type: 'input',
    name: 'privacyPolicyURL',
    message: 'Where will publish your Cookie Policy (e.g. https://yourcompany.com/cookie-policy)',
    validate: validate.webURL
  },
  {
    type: 'input',
  ...
  },
  {
    type: 'input',
    name: 'ticketingSystem',
    message: 'Name of ticketing system in use for issue/change management (e.g. Jira)'
  },
  {
    type: 'input',
    name: 'cmPortal',
    message: 'Link to system/portal that implements the production change management ticketing and workflow',
    validate: validate.webURL
  },
  {
    type: 'input',
    name: 'ciSystem',
    message: 'Name of Continuous Integration/Build system in use (e.g. Jenkins)'
  },
  {
    type: 'input',
    name: 'ciSystem',
    message: 'Name of the HR system your organization uses (e.g. Bamboo HR, EaseCentral)'
  },
  {
    type: 'confirm',
    name: 'haveSecurityScorecard',
    message: 'Do you produce a periodic security metrics scorecard / executive report',
    default: false
  }
];
